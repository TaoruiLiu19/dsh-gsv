		...
		function TtsSettingsCard({ scope, t }) {
			...
			return jsx.jsxs("div", { children: [
				...
				(draft.voices || []).map((v, i) => jsx.jsxs("div", { style: { border: "1px solid var(--dsw-alias-border-l2)", borderRadius: 8, padding: 8, marginBottom: 8 }, children: [
					...
					jsx.jsx("div", { style: { display: "flex", gap: 10, marginTop: 6 }, children: [
						jsx.jsx("button", { type: "button", disabled: previewBusy === i, onClick: () => previewOne(i), style: { cursor: "pointer", border: "none", background: "0 0", color: "var(--dsw-alias-brand,#6e56cf)", fontSize: 12, padding: 0 }, children: previewBusy === i ? t("voice.previewing") : (player.isActive(previewKey(i, v.name)) ? t("stop") : t("voice.preview")) }),
